...
- [x] compertiebel mit 8 bit aka. 1 bpp geräten
- [ ] compertiebel mit 8 bit aka. 1 bpp geräten (NO BUGS!!! CURRECT COLORS!)
- [x] compertiebel mit 24 bit aka. 3 bpp geräten
- [x] compertiebel mit 32 bit aka. 4 bpp geräten
